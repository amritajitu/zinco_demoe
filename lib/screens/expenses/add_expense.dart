...
import 'detail/from_aacount.dart';
...
class _AddExpensePageState extends State<AddExpensePage> {
  ...
  FocusNode calenderFCNode = FocusNode();
  FocusNode fromAccountFCNode = FocusNode();
  FocusNode toAccFCNode = FocusNode();
  FocusNode amountFCNode = FocusNode();
  FocusNode narationFCNode = FocusNode();
  FocusNode timeFCNode = FocusNode();
          ...
          child: ListView(
            children: [
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    ...
                    child: TextFormField(
                      focusNode: calenderFCNode,
                      onEditingComplete: () {
                        FocusScope.of(context).requestFocus(timeFCNode);
                      },
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      textAlign: TextAlign.center,
                      readOnly: true,
                      focusNode: timeFCNode,
                      onEditingComplete: () {
                        FocusScope.of(context).requestFocus(amountFCNode);
                      },
                      style: const TextStyle(color: Color(0xff878787)),
                      decoration: InputDecoration(
                          focusedBorder: const OutlineInputBorder(
              ...
              SizedBox(
                  ...
                  child: TextFormField(
                      focusNode: fromAccountFCNode,
                      onEditingComplete: () {
                        FocusScope.of(context).requestFocus(toAccFCNode);
                      },
                      validator: (value) {
                        if (value!.isEmpty) {
                      ...
                      onTap: () async {
                        var result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AccountDettails()),
                        );
              ...
              SizedBox(
                  ...
                  child: TextFormField(
                      ...
                      onEditingComplete: () {
                        FocusScope.of(context).requestFocus(narationFCNode);
                      },
                      validator: (value) {
                        if (value!.isEmpty) {
        ...
        onTap: () {
          if (_formKey.currentState!.validate()) {
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text("Enter something here to display on snack-bar")));
          } else {
            //           Navigator.of(context).push(MaterialPageRoute(builder: (context) => ExpenseList()));
          }
        },
      ),
    );
